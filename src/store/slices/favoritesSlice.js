...
const favoritesSlice = createSlice({
  ...
  reducers: {
    ...
    removeFromFavorites: (state, action) => {
      const { productId, sizeName, colorName } = action.payload;
    ...
    updateCartItemFavoriteStatus: (state, action) => {
      const { productId, sizeName, colorName, isFavorite } = action.payload;
...
export const selectIsFavorite = (state, productId, sizeName, colorName) =>
