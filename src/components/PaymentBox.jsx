...
export default function PaymentBox({ fix }) {
    ...
    return (
        <div
            className={(fix) ? "w-full flex flex-col gap-[8px] p-[16px] border-t-2 bg-white border-gray-100 fixed bottom-0" : "w-full flex flex-col gap-[8px] p-[16px] border-t-2 bg-white border-gray-100"}
        >
            ...
            <div className="flex flex-row-reverse items-center justify-center w-full m-auto rounded-lg bg-[#0095FF] gap-2 text-white p-[10px]">
                <span className="font-Lato text-[16px]">
                    الصافي للدفع
                </span>
                <div className="flex flex-row-reverse items-center gap-[4px]">
