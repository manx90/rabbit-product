...
export default function Category({ name, all, idCat, idSub }) {
  return (
    <div className='my-[12px] border border-b-blue-400'>
      <CategoryHeader idCat={idCat} idSub={idSub} name={name} all={all} />
    </div>
  );
}
